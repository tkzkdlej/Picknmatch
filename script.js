...
(function () {
  ...
  (function initSuccessStoriesPanel() {
    ...
    /** 이름: 성 + ** / 회사명은 블러 처리, 직무·분야만 명시 — 실제 헤드헌팅 실적(가명) */
    var MOCK_STORIES = [
      {
        name: "김**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">녹십자 계열</span> · 재무·회계</span>',
        text:
      ...
      },
      {
        name: "최**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">셀바이오텍 계열</span> · 쇼핑몰 웹개발</span>',
        text:
      ...
      },
      {
        name: "이**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">알피니언 메디칼</span> · 소프트웨어 개발</span>',
        text:
      ...
      },
      {
        name: "윤**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">세원정공</span> · 서울 영업</span>',
        text:
      ...
      },
      {
        name: "조**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">LS EV 계열</span> · 원가관리</span>',
        text:
      ...
      },
      {
        name: "박**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">셀바이오텍 계열</span> · 해외영업</span>',
        text:
      ...
      },
      {
        name: "최**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">세원정공</span> · 해외영업</span>',
        text:
      ...
      },
      {
        name: "강**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">SKCHTM</span> · 증착·코팅 개발</span>',
        text:
      ...
      },
      {
        name: "이**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">세원정공</span> · 생산관리</span>',
        text:
      ...
      },
      {
        name: "고**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">한화 에어로 계열</span> · 외자구매</span>',
        text:
      ...
      },
      {
        name: "이**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">셀바이오텍</span> · 인사기획</span>',
        text:
      ...
      },
      {
        name: "임**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">한양이엔지</span> · 전기공사</span>',
        text:
      ...
      },
      {
        name: "김**",
        companyHtml:
          '<span class="success-story-card__company"><span class="mask">SKCHTM</span> · 개발</span>',
        text:
